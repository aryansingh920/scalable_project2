...
if __name__ == "__main__":
    csv_file_path = r'C:\Users\Vishaalini\Downloads\Scalable Computing 2\ramasamv-challenge-filenames.csv'  # Path to your CSV
    download_directory = 'SCP2'  # Directory where files are saved
    output_csv_file = 'missing_files.csv'  # Output CSV file to save missing filenames
    ...
    missing_filenames = find_missing_files(original_filenames, downloaded_filenames)
    ...
    print(f"Missing files ({len(missing_filenames)}) have been saved to {output_csv_file}.")
