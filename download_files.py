...
def process_row(row, base_url, download_directory):
    ...
    filename = os.path.join(download_directory, url_extension)  # Save in the specified directory
...
if __name__ == "__main__":
    csv_file = r'C:/Users/Vishaalini/Downloads/Scalable Computing 2/missing_files.csv'  # Use raw string for Windows path
    base_url = 'https://cs7ns1.scss.tcd.ie/?shortname=ramasamv&myfilename='  # Replace with your base URL
