...
# to train
python3.10 src/image_processing/train/train.py --train-dataset "src/data/Aryan/captchas_test" --validate-dataset "src/data/Vishalini/captchas_test" --batch-size 64 --epochs 12 --output-model-name "src/image_processing/captcha_model.keras" --length 6 --width 192 --height 96 --symbols "src/image_processing/symbols.txt"
